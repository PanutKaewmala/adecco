...
class DatePickerCustom {
  ...
  ///
  static Future<DateTime?> showPickerCustom(
    BuildContext context, {
    bool showTitleActions = true,
    DateChangedCallback? onChanged,
    DatePickerFormat? datePickerFormat,
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Row _buildDatePickerFormat(
    ...
    switch (datePickerFormat) {
      ...
      case DatePickerFormat.mm_dd_yyyy:
        return _buildDatePickerWithMMDDYYYYFormat(theme);
      case DatePickerFormat.dd_mm_yyyy:
        return _buildDatePickerWithDDMMYYYYFormat(theme);
      case DatePickerFormat.mmmm_yyyy:
        return _buildDatePickerWithMMMMYYYYFormat(theme);
      default:
  ...
  Row _buildDatePickerWithMMMMYYYYFormat(DatePickerTheme theme) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        _buildMonth(theme),
